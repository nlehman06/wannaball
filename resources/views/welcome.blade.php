            ...
            <div class="pt-6 px-4 sm:px-6 lg:px-8">
                <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
                    ...
                    <div class="hidden md:block md:ml-10 md:pr-4">
                        ...
                        <a href="#"
                           class="ml-8 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">FAQ</a>
                        @guest
                            <a href="{{ route('login') }}"
                        ...
                        @else
                            <a href="{{ route('home') }}"
                               class="ml-8 font-medium text-indigo-600 hover:text-indigo-900 focus:outline-none focus:text-indigo-700 transition duration-150 ease-in-out">Dashboard</a>
                        @endguest
                    </div>
                </nav>
            </div>
                ...
                <div class="rounded-lg shadow-md">
                    <div class="rounded-lg bg-white shadow-xs overflow-hidden">
                        ...
                        <div class="px-2 pt-2 pb-3">
                            ...
                            <a href="#"
                               class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out">FAQ</a>
                        </div>
                        <div>
                            @guest
                                <a href="{{ route('login') }}"
                ...
                <div class="sm:text-center lg:text-left">
                    ...
                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                        <div class="rounded-md shadow">
                            <a href="@guest {{ route('login') }} @else {{ route('home') }} @endguest"
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-2 text-base leading-6 text-gray-500">
                                Leagues are a casual grouping of players, teams and locations. Easily schedule your next
                                pick-up game and keep everyone up to date.
                            </p>
                        </div>
                    </div>
                </li>
                <li class="mt-10 md:mt-0">
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-2 text-base leading-6 text-gray-500">
                                Automate the invite process of players. Quickly select from a list of players and see
                                who is ready to start playing.
                            </p>
                        </div>
                    </div>
                </li>
                <li class="mt-10 md:mt-0">
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-2 text-base leading-6 text-gray-500">
                                If your gym has a fee, it can be a pain to get everyone to pitch in with some cash. Give
                                your players the convenience to pay with a credit card.
                            </p>
                        </div>
                    </div>
                </li>
                <li class="mt-10 md:mt-0">
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-2 text-base leading-6 text-gray-500">
                                Keep track of who played and on which team. Who won? Even keep stats if you'd like.
                                Players can receive badges based on their performance and might even up the quality of
                                the games.
                            </p>
                        </div>
                    </div>
